...
var shareDiffCounter = promauto.NewCounterVec(prometheus.CounterOpts{
	Name: "pyi_valid_share_diff_counter",
...
var invalidCounter = promauto.NewCounterVec(prometheus.CounterOpts{
	Name: "pyi_invalid_share_counter",
